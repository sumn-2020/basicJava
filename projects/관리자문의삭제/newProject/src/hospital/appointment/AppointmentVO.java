...
public class AppointmentVO {
	...
	public String toString() {
		return String.format(
				"AppointmentVO [resCode=%s, resDate=%s, patCode=%s, docCode=%s, resMemo=%s, patName=%s, deptName=%s, docName=%s]",
				resCode, resDate, patCode, docCode, resMemo, patName, deptName, docName);
	}
