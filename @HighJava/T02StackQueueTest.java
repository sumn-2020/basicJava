...
public class T02StackQueueTest {
	public static void main(String[] args) {
		...
		/*
		 * stack 방식의 메서드 1) 자료 입력: push(저장할 값) 2) 자료 출력: pop() => 자료를 꺼내온 후 꺼내온 자료를
		 * stack에서 삭제한다.
		 * 
		 */
		stack.push("홍길동");
		...
		System.out.println("꺼내욘 자료: " + data);
		System.out.println("꺼내욘 자료: " + stack.pop());
		System.out.println("현재 stack값들 : " + stack);
		 ...
		 * Queue방식의 메서드 
		 * 1) 자료입력: offer(저장할 값) 
		 * 2) 자료출력: poll() => 자료를 queue에서 꺼내온 후 꺼내온
		 * 자료를 queue에서 삭제한다.
		 * 
		 */
		queue.offer("홍길동");
