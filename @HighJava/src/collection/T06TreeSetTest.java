...
public class T06TreeSetTest {
	public static void main(String[] args) {
		...
		// TreeSet에 저장된 자료 중 특정한 자료보다 작은 자료를 찾아서SortedSet으로 반환하는 메서드가 있다.
		// => hashSet(기준값) : 기본적으로 '기준값'은 포함시키지 않는다.
		// => tailSet(기준값, 논리값) : '논리값'0. 이 true이면 '기준값'을 포함시킨다.
		...
		System.out.println("K이후자료(기준값 미포함): " + ts.tailSet("K", false));
