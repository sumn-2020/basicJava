...
class Util {
	 ...
	 * 
	 */
	public static <K, V> boolean compare(Pair<K, V> p1, Pair<K, V> p2) { //제너릭 메소드
...
public class T02GernericMethodTest {
	public static void main(String[] args) {
		Pair<Integer, String> p1 = new Pair<Integer, String>(1, "홍길동");
		Pair<Integer, String> p2 = new Pair<Integer, String>(1, "홍길동");

		boolean result1 = Util.<Integer, String>compare(p1, p2); //(1, "홍길동") 키와 value가 같아서 출력은 두개가 동일하다고 나옴 // compare => 제너릭 메소드 
		...
		boolean result2 = Util.compare(p3, p4); //(1, "홍길동") 키와 value가 달라서 출력은 두개가 다르다고 나옴
