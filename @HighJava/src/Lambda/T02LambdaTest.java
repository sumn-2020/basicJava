...
public class T02LambdaTest {
	public static void main(String[] args) {
		 ...
		 * 
		 * 1) 매개변수의 '자료형이름'은 생략할 수 있다. 예) (int a)->{System.out.println(a);}
		 * (a)->{System.out.println(a);}
		 * 
		 * 2) 매개변수가 1개일 경우에는 괄호'()'를 생략할 수 있다 (단, '자료형이름'을 지정할 경우에는 생략할 수 없다)
		 * 
		 * 예) a -> {System.out.println(a);} 자료형 이름을 사용할 경우 괄호 써야됨 (int a) ->
		 * {System.out.println(a);}
		 * 
		 * 3) '실행문'이 1개일 경우에는 '{}'를 생략할 수 있다. (이 때 문장의 끝을 나타내는 세미콜론(;)도 생략한다.)
		 * 
...
//		lam3.accept(30);
		...
		LambdaInterface2 lam5 = z -> System.out.println("result = " + (z + 500));
		lam5.test(90);
		System.out.println("-------------------------------------------------");
